...
//index
$LANG['admin_site_title'] = '冶金离退休老干部局OA - 后台管理中心';
$LANG['expand_or_contract'] = '展开与收缩';
$LANG['phpcms_title'] = '冶金离退休老干部局OA管理系统';
...
$LANG['main_safety_permissions'] = '※ 建议您将目录设置为755（linux）或只读（windows）';
...
$LANG['domain_name_format'] = '域名可为空，格式应该为http://www.oa.cn/';
$LANG['domain_end_string'] = '格式应该为http://www.oa.cn/，请以‘/’结束';
...
$LANG['site_domain_ex'] = '请填写域名，格式为：http://www.oa.cn/';
$LANG['site_domain_ex2'] = '格式应该为http://www.oa.cn/，请以‘/’结束';
...
$LANG['phpcms_logon'] = '冶金离退休老干部局OA 登录';
