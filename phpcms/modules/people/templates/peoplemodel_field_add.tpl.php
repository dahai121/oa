...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $("#field").formValidator({
            ...
            type: "get",
            url: "",
            data: "m=people&c=sitemodel_field&a=public_checkfield&modelid=<?php echo $modelid?>",
            datatype: "html",
            cached: false,
...
<div class="pad_10">
    <div class="subnav">
        ...
        <div class="content-menu ib-a blue line-x">
            <a class="add fb"
               href="?m=people&c=sitemodel_field&a=add&modelid=<?php echo $modelid ?>&menuid=<?php echo $_GET['menuid'] ?>"><em><?php echo L('add_field'); ?></em></a>
            <a href="?m=people&c=sitemodel_field&a=init&modelid=<?php echo $modelid ?>&menuid=<?php echo $_GET['menuid'] ?>"><em><?php echo L('manage_field'); ?></em></a><span>|</span>
        </div>
        <div class="bk10"></div>
    </div>
    <form name="myform" id="myform" action="?m=people&c=sitemodel_field&a=add" method="post">
            ...
            <table width="100%" class="table_form contentWrap">
                <tr>
                    ...
                    <td>
                        ...
                        <input type="hidden" name="issystem" id="issystem" value="1">
                    </td>
                ...
                <!--tr>
                  ...
                  <td>
                      ...
                      <input type="radio" name="info[issystem]" id="field_basic_table1"
                             value="1" onclick="$('#issystem').val('1');" checked>
                      <!--?php echo L('yes'); ?>
                      <input type="radio" id="field_basic_table0" name="info[issystem]" value="0" onclick="$('#issystem').val('0');" >
                      <!--?php echo L('no'); ?>
                  </td>
                ...
                <tr>
                    <th>
                        <strong><?php echo L('relation_parm'); ?></strong><br/><?php echo L('relation_parm_tips'); ?>
                    </th>
                    <td>
                        <div id="setting"></div>
                    </td>
                ...
                <tr id="css">
                    <th><strong><?php echo L('form_css_name'); ?></strong><br/><?php echo L('form_css_name_tips'); ?>
                    </th>
                ...
                <tr>
                    ...
                    <td><?php echo L('minlength'); ?>£º<input type="text" name="info[minlength]" id="field_minlength"
                                                             value="0" size="5"
                                                             class="input-text"> <?php echo L('maxlength'); ?>£º<input
                            type="text" name="info[maxlength]" id="field_maxlength" value="" size="5"
                            class="input-text"></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="radio" name="info[isunique]" value="1" id="field_allow_isunique1"> <?php echo L('yes'); ?> <input type="radio" name="info[isunique]" value="0" id="field_allow_isunique0" checked> <?php echo L('no'); ?>
                    </td>
                </tr>
                <tr>
                    <th><strong><?php echo L('basic_field'); ?></strong><br/><?php echo L('basic_field_tips'); ?></th>
                    <td><input type="radio" name="info[isbase]" value="1" checked> <?php echo L('yes'); ?> <input
                            type="radio" name="info[isbase]" value="0"> <?php echo L('no'); ?> </td>
                </tr>
                <tr>
                    <th><strong><?php echo L('as_search_field'); ?></strong></th>
                    <td><input type="radio" name="info[issearch]" value="1"
                               id="field_allow_search1"> <?php echo L('yes'); ?> <input type="radio" name="info[issearch]" value="0" id="field_allow_search0" checked> <?php echo L('no'); ?>
                    </td>
                </tr>
                <tr>
                    <th><strong><?php echo L('allow_contributor'); ?></strong></th>
                    <td><input type="radio" name="info[isadd]" value="1" checked/> <?php echo L('yes'); ?> <input
                            type="radio" name="info[isadd]" value="0"/> <?php echo L('no'); ?></td>
                </tr>
                <tr>
                    <th><strong><?php echo L('as_fulltext_field'); ?></strong></th>
                    <td><input type="radio" name="info[isfulltext]" value="1" id="field_allow_fulltext1"
                               checked/> <?php echo L('yes'); ?> <input type="radio" name="info[isfulltext]" value="0" id="field_allow_fulltext0"/> <?php echo L('no'); ?>
                    </td>
                </tr>
                <tr>
                    <th>
                    ...
                    <td><input type="radio" name="info[isomnipotent]" value="1"/> <?php echo L('yes'); ?> <input
                            type="radio" name="info[isomnipotent]" value="0" checked/> <?php echo L('no'); ?></td>
                </tr>
                <tr>
                    <th><strong><?php echo L('as_postion_info'); ?></strong></th>
                    <td><input type="radio" name="info[isposition]" value="1"/> <?php echo L('yes'); ?> <input
                            type="radio" name="info[isposition]" value="0" checked/> <?php echo L('no'); ?></td>
                </tr>
                <tr>
    ...
    <script type="text/javascript">
        ...
        function field_setting(fieldtype) {
            ...
            $.getJSON("?m=people&c=sitemodel_field&a=public_field_setting&fieldtype=" + fieldtype, function (data) {
