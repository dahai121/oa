...
<table width="100%" cellspacing="0">
	<thead>
		<tr>
			...
			<th align="left"><?php echo L('待遇')?></th>
...
?>
    <tr>
		...
		<td align="left"><?php echo $v['zj']?></td>
		<td align="left"><?php echo $v['xuhao']?></td>
		<td align="left"><?php echo $v['dy']?></td>
		<td align="left"><?php echo $v['zybz']?></td>
		<td align="left"><a href="#"> <?php echo "档案情况" ?> </a></td>
