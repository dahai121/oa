...
<form name="myform" id="myform" action="?m=people&c=people&a=add_tx&modelid=<?php echo $modelid; ?>" method="post"
      enctype="multipart/form-data">

    <div class="addContent">

        <div class="crumbs"><?php echo L('add_people'); ?></div>
        <div class="col-right">
            <div class="col-1">
                <div class="content pad-6">
                    ...
                    <?php if ($_SESSION['roleid'] == 1 || $priv_status) { ?>
                        ...
                        <span class="ib" style="width:90px"><label><input type="radio" name="status" value="99"
                                                                          checked/> <?php echo L('c_publish'); ?> </label></span>
                        <?php if ($workflowid) { ?><label><input type="radio" name="status"
                                                                 value="1"> <?php echo L('c_check'); ?>
                            </label><?php } ?>
                    <?php } ?>
                </div>
            </div>
