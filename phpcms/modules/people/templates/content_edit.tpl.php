...
<form name="myform" id="myform" action="?m=people&c=people&a=edit" method="post" enctype="multipart/form-data">
                ...
                <div class="content pad-6">
                    ...
                    if (is_array($forminfos['senior'])) {
                        foreach ($forminfos['senior'] as $field => $info) {
                            ...
                            ?>
                            <h6><?php if ($info['star']) { ?> <font
                                    color="red">*</font><?php } ?> <?php echo $info['name'] ?></h6>
                    ...
                    <table width="100%" cellspacing="0" class="table_form">
                        ...
                        if (is_array($forminfos['base'])) {
                            foreach ($forminfos['base'] as $field => $info) {
                                ...
                                ?>
                                <tr>
                                    <th width="80"><?php if ($info['star']) { ?> <font
                                            color="red">*</font><?php } ?> <?php echo $info['name'] ?>
                                    </th>
    ...
    <div class="fixed-bottom">
        <div class="fixed-but text-c">
            <div class="button">
                ...
                <input value="<?php echo $modelid; ?>" type="hidden" name="modelid">
                <input value="<?php echo L('save_close'); ?>" type="submit" name="dosubmit" class="cu" onclick="refersh_window()">

                 </div>
            <div class="button">
                <input value="<?php echo L('save_continue'); ?>" type="submit" name="dosubmit_continue" class="cu" onclick="refersh_window()">
            </div>
            <div class="button">
                <input value="<?php echo L('c_close'); ?>" type="button" name="close" onclick="refersh_window();close_window();" class="cu" title="Alt+X">
            </div>
        </div>
    </div>
</form>
