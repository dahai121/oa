...
?>
<div class="pad-lr-10">
<form action="index.php?m=oattendance&c=oattendance&a=check&attid=<?php echo $attid?>" method="post" name="myform" id="myform">
<table cellpadding="2" cellspacing="1" class="table_form" width="100%">
	...
	<tr><th></th><td>
		<input type="submit" name="dosubmit" id="dosubmit" class="dialog" value="审核通过"></td>
	</tr>
</table>
</form>
</div>
