...
<table width="100%" cellspacing="0">
	<thead>
		<tr>
			...
			<th align="left"><?php echo L('position')?></th>
			<th align="left">ËùÔÚ´¦ÊÒ</th>
...
?>
    <tr>
		...
		<td align="left"><img src="<?php echo $v['avatar']?>" height=18 width=18 onerror="this.src='<?php echo IMG_PATH?>member/nophoto.gif'"><?php echo $v['username']?><a href="javascript:member_infomation(<?php echo $v['userid']?>, '<?php echo $v['modelid']?>', '')"><?php echo $member_model[$v['modelid']]['name']?><img src="<?php echo IMG_PATH?>admin_img/detail.png"></a></td>
		...
		<td align="left"><?php echo get_linkage(get_memberdetail($v['userid'],'position'),3360,'>>',2) ?></td>
		<td align="left"><?php echo get_linkage(get_memberdetail($v['userid'],'dept'),3376,'>>',2) ?></td>
