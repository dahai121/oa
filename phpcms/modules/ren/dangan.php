...
//        var_dump( $memberlist);die;
    ...
    function tx_manage() {
        ...
        //后台模板
        $template = $this->p_model['admin_list_template'] ? $this->p_model['admin_list_template'] : 'people_list';
        $big_menu = array('javascript:window.top.art.dialog({id:\'add\',iframe:\'?m=people&c=people&a=add_tx&modelid='.$modelid.'\', title:\''.L('添加人员').'\', width:\'1200\', height:\'500\', lock:true}, function(){var d = window.top.art.dialog({id:\'add\'}).data.iframe;var form = d.document.getElementById(\'dosubmit\');form.click();return false;}, function(){window.top.art.dialog({id:\'add\'}).close()});void(0);', L('添加人员'));
        include $this->admin_tpl($template);
    }
    ...
    function dangan_manage() {
        ...
        //后台模板
        $template = $this->p_model['admin_list_template'] ? $this->p_model['admin_list_template'] : 'people_list';
        $big_menu = array('javascript:window.top.art.dialog({id:\'add\',iframe:\'?m=people&c=people&a=add_dangan&modelid='.$modelid.'\', title:\''.L('添加人员').'\', width:\'1200\', height:\'500\', lock:true}, function(){var d = window.top.art.dialog({id:\'add\'}).data.iframe;var form = d.document.getElementById(\'dosubmit\');form.click();return false;}, function(){window.top.art.dialog({id:\'add\'}).close()});void(0);', L('添加人员'));
        include $this->admin_tpl($template);
    }
...
//        }
        ...
        $big_menu = array('javascript:window.top.art.dialog({id:\'add\',iframe:\'?m=people&c=people&a=add\', title:\''.L('添加人员').'\', width:\'1200\', height:\'600\', lock:true}, function(){var d = window.top.art.dialog({id:\'add\'}).data.iframe;var form = d.document.getElementById(\'dosubmit\');form.click();return false;}, function(){window.top.art.dialog({id:\'add\'}).close()});void(0);', L('添加人员'));
