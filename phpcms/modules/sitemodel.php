...
class sitemodel extends admin {
	...
	public function init() {
        ...
        $datas = $this->db->listinfo(array('type'=>3),'',$_GET['page'],30);
        //模型文章数array('模型id'=>数量);
		$items = array();
		...
		include $this->admin_tpl('peoplemodel_manage');
	}
    ...
    public function add() {
        if(isset($_POST['dosubmit'])) {
            ...
            $this->type_db->insert(array('name'=>$_POST['info']['name'],'module'=>'people','modelid'=>$modelid,'siteid'=>$this->siteid));
            ...
            include $this->admin_tpl('people_model_add');
        }
    }
