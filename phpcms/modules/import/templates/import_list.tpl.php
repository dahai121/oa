...
<table width="100%" cellspacing="0">
	<thead>
		<tr>
			<th width="35" align="center"><input type="checkbox" value="" id="check_box" onclick="selectall('importid[]');"></th>
...
if(is_array($infos)){
	foreach($infos as $info){
		?>
	<tr>
		<td align="center" width="35"><input type="checkbox" name="importid[]" value="<?php echo $info['id']?>"></td>
		...
		<td width='15%' align="center"><?php if($info['lastinputtime']){echo date("Y-m-d H:i:s",$info['lastinputtime']);}else {echo '<font color=red>Î´Ö´ÐÐ</font>';}?></td>
