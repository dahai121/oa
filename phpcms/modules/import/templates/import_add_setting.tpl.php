...
<fieldset>
    ...
    <td class="y-bg"> 
	<input type="radio" name="info[type]" value="content" checked="" onclick="$('#other_model').hide();$('#member_model').hide();$('#content_model').show();" class="radio_style"> <?php echo L('content_import')?> <input type="radio" name="info[type]" value="member" onclick="$('#member_model').show();$('#content_model').hide();$('#other_model').hide();" class="radio_style"> <?php echo L('member_import')?> <input type="radio" name="info[type]" value="other" onclick="$('#other_model').show();$('#member_model').hide();$('#content_model').hide();" class="radio_style"> <?php echo L('other_import')?>
	</td>
	</tr>
