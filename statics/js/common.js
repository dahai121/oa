...
var C={
    ...
    */
    "alert":{
        "params":{
          "width":"300","height":"100","title":"温馨提示","content":"","timeout":"1000","top":"9","alert_style":{'border':'1px solid #333','color':'red'},'border':'1','border_radius':'6',
        ...
        */
        "tips":function(params){
            ...
            var ntop=parseInt($(document).scrollTop())+parseInt(top);//alert(ntop);//border: 1px solid #696;text-align: center;-webkit-border-radius: 8px;-moz-border-radius: 8px;border-radius: 8px;-webkit-box-shadow: #666 0px 0px 10px;-moz-box-shadow: #666 0px 0px 10px;box-shadow: #666 0px 0px 10px;background: #EEFF99;
        ...
        "opacty":function(params){
          ...
          //样式
            class_opacty={'display':'block','position':'absolute','width': opacty_width +'px','height':h_doc - 4+'px','background':'#eee','top':'0px','left':'0px','filter':'Alpha(opacity=20)','opacity':'0.3'};//透明层
            ...
            if(params.url != undefined ){
                ...
                var div_tips = '<div class="div_tips" style="-webkit-box-shadow:#333 0px 0px 12px;-moz-box-shadow:#333 0px 0px 12px;box-shadow:#333 0px 0px 12px;overflow:hidden;-moz-border-radius:' + border_radius_style + 'px;-webkit-border-radius:' + border_radius_style + 'px;border-radius:' + border_radius_style + 'px;">' + tips_tit + '<iframe name="iframe_info" scrolling="no" class="iframe_info" src="' + params.url + '" ></iframe></div>'; //内容
                $('body').append(div_tips);
                var iframe_style = {'overflow':'hidden','margin':'0','padding':'0','border':'0','width':'100%','height':height - $('.tips_tit').height()+10 + 'px'};//iframe 元素样式
            ...
            if(params.content != undefined){
                ...
                $('.opacty').css(class_opacty);
                //创建提示层
                var div_tips = '<div class="div_tips" style="-webkit-box-shadow:#333 0px 0px 12px;-moz-box-shadow:#333 0px 0px 12px;box-shadow:#333 0px 0px 12px;-moz-border-radius:' + border_radius_style + 'px;-webkit-border-radius:' + border_radius_style + 'px;border-radius:' + border_radius_style + 'px;">' + tips_tit + '<div class="tips_content"><table cellspacing="0" cellpadding="0" width="100%" height="60%" border="0"><tr><td align="center">' + content + '</td></tr></table><div></div>';
                $('body').append(div_tips);
                var opacty_zindex=10001;
	...
	//倒计时 调用方式//C.countDown("2014/3/16 23:55:00","#colockbox1"); 参数 截止日期 ， 调用位置
	"countDown":function(time,obj){
		var insHtml ='<span id="day">00</span>天<span id="hour">00</span>小时<span id="minute">00</span>分钟<span id="second">00</span>秒'; //html 结构
		$(obj).append(insHtml);
    ...
    */
    ...
    "create_upload_iframe":function(params,frame_width){
        ...
        params=$.toJSON(a);
        var frame_code='<iframe style="" src=\''+upload_path+'upload/upload_form.php?params='+encodeURIComponent(params)+'\' width="'+frame_width+'" height="28" frameborder="no" border="0″ marginwidth="0″ marginheight="0" scrolling="no" allowtransparency="yes"></iframe>';
        if(a.inner_box){
    ...
    "ckeditor":{
        ...
        "init":function(upload_btn,editor,water){
            ...
            C.create_upload_iframe('{"func":"C.ckeditor.callback","inner_box":"'+upload_btn+'","editor":"'+editor+'","thumb":{"width":"300","height":"300"},"water":"'+water+'"}');
        }
    },
